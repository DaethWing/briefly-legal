...
/* =========================
   TEMPLATE GENERATORS (TG)
   Highly curated set of explicit generators for top templates.
   All others use category-aware fallbacks below.
   ========================= */
const TG = {
  // --- NDAs ---
  "NDA (Mutual)": (i) => [
